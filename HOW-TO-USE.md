...
ODOO_MCP_PUBLIC_URL=https://64.181.194.210:8443
...
## After Git Pull On The Odoo Server
...
curl -k -I https://64.181.194.210:8443
```
...
If local curl works but public curl fails, open TCP `8443`:
...
For OCI, also add an ingress rule:
